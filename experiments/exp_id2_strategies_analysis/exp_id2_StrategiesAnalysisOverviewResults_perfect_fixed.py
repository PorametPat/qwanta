...
def execute(parameter):
    ...
    exps = Xperiment(
        ...
        experiment = f'exp_id2_StrategiesAnalysisOverviewResults_perfect_fixed_p{index}_r{repeat_th}',
        strategies_list=['2G-NonLocalCNOT-Perfect', '1-2G-DirectedEncoded-Perfect']
    )
...
num_trajectories = 10
exp_names = ['2G-NonLocalCNOT-Perfect', 
...
# %%
message_log = 'exp_id2_StrategiesAnalysisOverviewResults_perfect_fixed'
...
DataFrame.to_csv('exp_id2_StrategiesAnalysisOverviewResults_perfect_fixed_Extracted_Data.csv', index=False)
