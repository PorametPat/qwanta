...
def execute(parameter):
    ...
    exps = Xperiment(
        ...
        experiment = f'exp_id2_StrategiesAnalysisNoiseSensitivity_perfect_fixed_p{index}_r{repeat_th}',
...
# %%
message_log = 'exp_id2_StrategiesAnalysisNoiseSensitivity_perfect_fixed'
